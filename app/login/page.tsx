  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f9f9f9] py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-[rgba(26,28,28,0.02)] rounded-none blur-3xl animate-pulse-soft" />
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-[rgba(26,28,28,0.01)] rounded-none blur-3xl animate-pulse-soft" style={{ animationDelay: '1s' }} />
      </div>
      ...
      >
        ...
        <Suspense fallback={
          <div className="flex justify-center">
            <div className="w-12 h-12 border border-[#000000] border-t-transparent animate-spin" />
          </div>
        }>
          <LoginForm />
        </Suspense>
